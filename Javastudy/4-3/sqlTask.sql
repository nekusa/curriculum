...
-- [回答]
	//修正点①-	SELECT * FROM↓
	//		SELECT  store_name AS 店舗名, goods_name AS 商品名, quantity AS 在庫数 FROM
	SELECT  store_name AS 店舗名, goods_name AS 商品名, quantity AS 在庫数 FROM stock_table AS a
	JOIN store_table AS b 
		ON a.store_code = b.store_code
	JOIN goods_table AS c
