...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            // ←ここへ記述
        	responseBean = ems.getEmployeeData(EmployeeDao.ExecuteCase.FIND_BY_EMPID, resEmployeeBean = new EmployeeBean(reqEmpId));
            // 最初の1件を取得
            ...
            if (Objects.nonNull(resEmployeeBean)) {
                ...
                if(PasswordHashUtil.getSafetyPassword(resEmployeeBean.getPassword(), resEmployeeBean.getEmpId()).equals(hashPassword)) {
                    // ログイン成功
